...
1. First, install an addon via Anki Addon Manager using this code: `<number`
...
2. Input `<number>` into the text box labeled `Code` and press the `OK` button to proceed.
